...
def create_lists(save_path, train_split=0.9):
    ...
    def write_list(speaker_list, list_path):
    ...
    write_list(train_speakers, os.path.join(save_path, 'train_list.txt'))
    write_list(test_speakers, os.path.join(save_path, 'test_list.txt'))
